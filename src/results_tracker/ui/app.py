...
from results_tracker.ui import (ablation, comparison, curves, export, import_runs, overview, paper, run_detail, runs,
                                settings, studies, sweep, tradeoff, visual)
...
# Grouped, or Streamlit folds a long flat list into "View N more" and hides half the app.
pages = {
    "Results": [
    ...
    "Runs": [
        ...
        st.Page(import_runs.render, title="Import", icon="📥", url_path="import"),
    ],
    "Paper": [
...
# expanded: Streamlit otherwise folds everything past the tenth page behind "View 3 more".
